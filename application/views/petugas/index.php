                      ...
                      <div class="modal-dialog" align="center">
                        <div class="modal-content" style="max-width: 300px;">
                          ...
                          <div class="modal-body" align="center">
                             <a href="<?php echo base_url() ?>petugas/delete/<?php echo $key['user_id'] ?>"><button class="btn btn-success" style="width: 49%;">Yes</button></a>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form role="form" method="post" action="<?php echo base_url('petugas/update/'.$key['user_id']) ?>" enctype="multipart/form-data">
                          <div class="box-body">
  ...
  <div class="modal fade" id="modal-album">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="<?php echo base_url('petugas/add') ?>" enctype="multipart/form-data">
            <div class="box-body">
              <div class="form-group">
                <label>Nama</label>
